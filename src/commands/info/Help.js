  ...
  async run(client, ctx, args) {
    ...
    if (!args[0]) {
      ...
      const helpEmbed = embed
        ...
        .setTitle("Help Menu")
        .setDescription(
          `Hey there! I'm ${this.client.user.username}, a music bot made by [Anusara](https://github.com/anusara-bemal) and Discord. You can use \`${prefix.prefix}help <command>\` to get more info on a command.`
        )
        .setFooter({
